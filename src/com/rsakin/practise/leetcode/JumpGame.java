...
public class JumpGame {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Min step to end : " + new JumpGame().jump(nums1));
        ...
        System.out.println("Min step to end : " + new JumpGame().jump(nums2));
        ...
        System.out.println("Min step to end : " + new JumpGame().jump(nums3));
        ...
        System.out.println("Min step to end : " + new JumpGame().jump(nums4));
